...
class ListeningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create listening" do
    assert_difference("Listening.count") do
      post listenings_url, params: { listening: { level: @listening.level, title: @listening.title } }
    end
  ...
  test "should update listening" do
    patch listening_url(@listening), params: { listening: { level: @listening.level, title: @listening.title } }
