...
export default class extends Controller {
    ...
    toggleForm(event) {
        ...
        // Get correction Body Id
        const correctionBodyID = event.params["body"];
        // Get Edit Button Id
        ...
        // Grab correction Body using Id
        const correctionBody = document.getElementById(correctionBodyID);
        // Toggle Visability
        correctionBody.classList.toggle("d-none");
